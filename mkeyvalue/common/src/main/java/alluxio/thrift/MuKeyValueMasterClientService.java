...
public class MuKeyValueMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * @param path the path of the store
     */
    public List<MuPartitionInfo> getPartitionInfo(String path) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public List<MuPartitionInfo> recv_getPartitionInfo() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public static class getPartitionInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<MuPartitionInfo> getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class getPartitionInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPartitionInfo_args, List<MuPartitionInfo>> {
      public getPartitionInfo() {
        super("getPartitionInfo");
      }
      ...
      public AsyncMethodCallback<List<MuPartitionInfo>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<MuPartitionInfo>>() { 
          public void onComplete(List<MuPartitionInfo> o) {
            getPartitionInfo_result result = new getPartitionInfo_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getPartitionInfo_args args, org.apache.thrift.async.AsyncMethodCallback<List<MuPartitionInfo>> resultHandler) throws TException {
  ...
  public static class getPartitionInfo_result implements org.apache.thrift.TBase<getPartitionInfo_result, getPartitionInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPartitionInfo_result>   {
    ...
    public List<MuPartitionInfo> success; // required
    public alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MuPartitionInfo.class))));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getPartitionInfo_result(getPartitionInfo_result other) {
      if (other.isSetSuccess()) {
        List<MuPartitionInfo> __this__success = new ArrayList<MuPartitionInfo>(other.success.size());
        for (MuPartitionInfo other_element : other.success) {
          __this__success.add(new MuPartitionInfo(other_element));
        }
    ...
    public java.util.Iterator<MuPartitionInfo> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(MuPartitionInfo elem) {
      if (this.success == null) {
        this.success = new ArrayList<MuPartitionInfo>();
      }
      this.success.add(elem);
    }

    public List<MuPartitionInfo> getSuccess() {
      return this.success;
    }

    public getPartitionInfo_result setSuccess(List<MuPartitionInfo> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<MuPartitionInfo>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<MuPartitionInfo>(_list0.size);
                  MuPartitionInfo _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new MuPartitionInfo();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPartitionInfo_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (MuPartitionInfo _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (MuPartitionInfo _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<MuPartitionInfo>(_list5.size);
            MuPartitionInfo _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new MuPartitionInfo();
              _elem6.read(iprot);
